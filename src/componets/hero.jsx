...
const HeroSection = () => {
  ...
  return (
    <section
      id="hero"
      className="bg-neutral-900 overflow-x-hidden text-white py-10 min-h-[70vh] flex items-center"
    >
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 mb-10 md:mb-0 animate__animated animate__fadeInLeft">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              <span className="text-accent">ChatGPT</span> That Speaks Your
              Brand!
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-gray-300">
              Elevate your business with AI-driven chatbots designed to provide
              engaging, personalized conversations.
            </p>
        ...
        <div className="flex justify-center mt-16">
          <div className="flex items-center space-x-8 animate__animated animate__fadeIn">
            <div className="text-center">
              <div className="text-accent text-2xl sm:text-3xl md:text-4xl font-bold mb-2">
                24/7
              </div>
