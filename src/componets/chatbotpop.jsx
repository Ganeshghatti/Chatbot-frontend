...
const Chatbotpop = () => {
  ...
  return (
    <div>
      <button
        className="fixed lg:bottom-5 bottom-3 left-5 bg-accent hover:bg-accent-400 text-white rounded-full p-3 lg:p-4 shadow-lg text-xl hover:bg-accent-600 cursor-pointer focus:outline-none z-10"
      ...
      <div
        className={`fixed lg:bottom-40 bottom-53 lg:left-18 shadow-lg rounded-lg lg:p-5 p-6 w-92 lg:w-100 lg:h-96 h-95 z-20 transition-transform duration-500 ease-in-out ${
          isChatbotVisible
